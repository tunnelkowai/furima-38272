class User < ApplicationRecord
  ...
  validates :last_name,       presence: true, format: { with: /\A[ぁ-ゔァ-ヴ一-龥]/, message: "is invalid. Input full-width characters" }
  validates :first_name,      presence: true, format: { with: /\A[ぁ-ゔァ-ヴ一-龥]/, message: "is invalid. Input full-width characters"}
